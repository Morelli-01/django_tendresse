"""
URL configuration for django_tendresse project.
...
urlpatterns = [
    ...
    path("humans.txt",TemplateView.as_view(template_name="seo/humans.txt", content_type="text/plain")),
    path("llms.txt",TemplateView.as_view(template_name="seo/llms.txt", content_type="text/plain")),
